...
class RecentProfilePosts extends StatefulWidget {
  final String profileOwner;
  final User user;

  const RecentProfilePosts({
    required this.profileOwner,
    required this.user,
  });

  @override
  _RecentProfilePostsState createState() => _RecentProfilePostsState();
}

class _RecentProfilePostsState extends State<RecentProfilePosts> {
  List reactorList = [];
                                  ...
                                  ownerId == Constants.myId
                                      ? Padding(
                                          ...
                                          child: TextButton(
                                            ...
                                            onPressed: () => {
                                              deleteFunc(postsId, ownerId, type,
                                                  index),
                                            },
                                          ),
                                        )
...
//                    subtitle: Text(description),
  ...
  deleteFunc(String postId, String ownerId, String type, int index) {
    if (type == 'meme' ||
        type == "memeT" ||
        type == "videoMeme" ||
        type == "videoMemeT") {
