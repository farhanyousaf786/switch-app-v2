...
class AddRemoveCompTopic extends StatefulWidget {
  @override
  _AddRemoveCompTopicState createState() => _AddRemoveCompTopicState();
}

class _AddRemoveCompTopicState extends State<AddRemoveCompTopic> {
  ...
  void setTopics() {
    if (textMemeTopic.text.isNotEmpty && textMemeTopicDetails.text.isNotEmpty) {
      switchCompTopicListRTD.child(postId).set({
