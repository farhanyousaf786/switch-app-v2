...
class RemoveCompWinner extends StatefulWidget {
  @override
  _RemoveCompWinnerState createState() => _RemoveCompWinnerState();
}

class _RemoveCompWinnerState extends State<RemoveCompWinner> {
