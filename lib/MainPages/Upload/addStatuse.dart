...
//
//   _loadGallery() {
//     if (widget.type == "photo" || widget.type == "meme") {
...
//                     ))
//                 : ElevatedButton(
//                     onPressed: () => controllAndUploadData(),
...
//       String downloadUrl;
//
//       downloadUrl = await uploadVideo(file);
//
...
//         .child("UsersPosts/${Constants.myId}/${Constants.myEmail}/_$postId.jpg")
//         .putFile(mImageFile);
...
//     StorageUploadTask mStorageUploadTask = storageReference
//         .child("postVideos/${Constants.myId}/_$postId.mp4/")
//         .putFile(mVideoFile, StorageMetadata(contentType: "video/mp4"));
//
//     StorageTaskSnapshot storageTaskSnapshot =
//         await mStorageUploadTask.onComplete;
//     String downloadUrl = await storageTaskSnapshot.ref.getDownloadURL();
