...
//     if (jumpEndAt > 400) {
//       Fluttertoast.showToast(
//         msg: "Last 400+ posts has been seen",
//         toastLength: Toast.LENGTH_LONG,
//         gravity: ToastGravity.TOP,
//         timeInSecForIosWeb: 3,
//         backgroundColor: Colors.blue.withOpacity(0.8),
...
//                             child: Flexible(
//                                 child: Text(
//                                   "You can earn monthly prize upto 1000 pkr if you held one of top 3 slot in Switch App as a Memer.",
//                                   style: TextStyle(
//                                       color: Colors.blue.shade700,
//                                       fontFamily: 'cutes',
//                                       fontSize: 13),
...
//                    subtitle: Text(description),
  ...
  GlobalKey favoritesIntro = GlobalKey();
